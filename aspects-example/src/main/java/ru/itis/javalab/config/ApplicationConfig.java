...
public class ApplicationConfig {
    ...
    private Properties additionalProperties() {
        ...
        properties.setProperty("hibernate.physical_naming_strategy", "ru.itis.javalab.config.SnakeCasePhysicalNamingStrategy");
        return properties;
    }
    ...
    public DataSourceInitializer dataSourceInitializer(@Qualifier("dataSource") final DataSource dataSource) {
        ...
        resourceDatabasePopulator.addScript(new ClassPathResource("sql/schema-postgresql.sql"));
